...
function Footer() {
    return (
        <View className="mx-auto w-full bg-red-500 px-6 py-12">
            {/* TOP ROW */}
            <View className="flex-row items-start justify-center gap-32">
                {/* LOGO */}
                <View className="w-[220px]">
                    <Text className="text-[24px] font-bold text-white">HelpHub</Text>
                </View>

                {/* LINKS COL 1 */}
                <View className="items-center gap-3 text-center">
                    <Link href={"/how-it-works" as any} asChild>
                        <Text className="text-[16px] font-semibold text-white">How it works?</Text>
                    </Link>
                    <Link href={"/about" as any} asChild>
                        <Text className="text-[16px] text-white">About Us</Text>
                    </Link>
                    <Link href={"/contact" as any} asChild>
                        <Text className="text-[16px] text-white">Contact</Text>
                    </Link>
                    <Link href={"/blog" as any} asChild>
                        <Text className="text-[16px] text-white">Blog</Text>
                    </Link>
                </View>
                ...
                <View className="items-center gap-3 text-center">
                    <Link href={"/terms" as any} asChild>
                        <Text className="text-[16px] text-white">Terms of Use</Text>
                    </Link>
                    <Link href={"/privacy" as any} asChild>
                        <Text className="text-[16px] text-white">Privacy Policy & GDPR</Text>
                    </Link>
                    <Link href={"/distance-sales" as any} asChild>
                        <Text className="text-[16px] text-white">Distance Sales Agreement</Text>
                    </Link>
                    <Link href={"/refund" as any} asChild>
                        <Text className="text-[16px] text-white">Refund Policy</Text>
                    </Link>
                    <Link href={"/cookies" as any} asChild>
                        <Text className="text-[16px] text-white">Cookie Policy</Text>
                    </Link>
                </View>

                {/* SOCIAL + STORES */}
                <View className="items-start gap-4">
                    <Text className="text-[16px] font-semibold text-white">Follow Us</Text>
            ...
            <View className="mt-12 items-center">
                <Text className="max-w-[900px] text-center text-[14px] leading-[24px] text-white">
                ...
                <Text className="mt-4 text-center text-[14px] text-white">
